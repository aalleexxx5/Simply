...
public class Inc extends Command {
    @Override
    public String use() {
        return "inc <varname> (optional)<amount>";
    }

    @Override
    public String description() {
        return "increment a variable by something or just one";
    }
    ...
    public boolean execute(String[] args) {
        ...
        Viewer.print("The variable you are trying to increment was not a number:" + a[0]);
        return false;
    }
}
